...
class PurchaseScreen extends StatelessWidget {
  ...
  final int paidPrice = 500;

  /// Build payment object
  Map<String, dynamic> buildPayment({
  ...
  Widget build(BuildContext context) {
    final gradientGeneral = const LinearGradient(
      colors: [Color(0xFFc678ff), Color(0xFF99c7ff)],
    );

    final gradientPaid = const LinearGradient(
      colors: [Color(0xFFd67bff), Color(0xFF89b6ff)],
    );
        ...
        child: Column(
          children: [
            ...
            planCard(
              ...
              onBuy: () {
                const String merchantId = "1232877"; // PayHere sandbox ID

                startPayment(
                  context,
                  sandbox: true,
                  merchantId: merchantId,
                  amount: paidPrice.toDouble(),
                );
              },
            ),
          ],
